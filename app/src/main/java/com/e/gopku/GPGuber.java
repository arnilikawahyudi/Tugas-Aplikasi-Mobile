...
public class GPGuber extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan){
        ...
        try {
            ...
            if (pilihan.equals("Call Center")){
                String tel = "tel:076147367";
                gu = new Intent(Intent.ACTION_DIAL, Uri.parse(tel));

            }else if (pilihan.equals("Info Maps")){
                String geo = "geo:0.517727,101.445839";
                gu = new Intent(Intent.ACTION_VIEW,Uri.parse(geo));
                // set app defualt untuk buka intent ini apabila ada beberapa aplikasi yang dapat membuka
                gu.setPackage("com.google.android.apps.maps");

            }else if (pilihan.equals("Driving Direction")){
                String geo ="google.navigation:q=0.517727,101.445839";
                gu = new Intent(Intent.ACTION_VIEW,Uri.parse(geo));

            }else if (pilihan.equals("Website")){
                String web = "http://riau.go.id";
                gu = new Intent(Intent.ACTION_VIEW,Uri.parse(web));

            }else if (pilihan.equals("Search Info")){
                gu = new Intent(Intent.ACTION_WEB_SEARCH);
                gu.putExtra(SearchManager.QUERY,("Kantor Gubernur Riau"));
                ...
                gu = new Intent(Intent.ACTION_VIEW,dekatsaya);
                gu.setPackage("com.google.android.apps.maps");
