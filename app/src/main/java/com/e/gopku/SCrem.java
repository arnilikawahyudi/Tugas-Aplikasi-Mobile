...
public class SCrem extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan){
        ...
        try {
            ...
            if (pilihan.equals("Call Center")){
                ...
                String geo = "geo:0.475385,101.453059";
                ...
                String geo ="google.navigation:q=0.475385,101.453059";
                re = new Intent(Intent.ACTION_VIEW,Uri.parse(geo));
                ...
                re.putExtra(SearchManager.QUERY,("Gelanggang Olahraga Remaja Pekanbaru"));
