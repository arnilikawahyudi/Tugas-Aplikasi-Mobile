...
public class ToKepiting extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan){
        ...
        try {
            ...
            if (pilihan.equals("Call Center")){
                ...
                String geo ="google.navigation:q=0.520220,101.457001";
                k = new Intent(Intent.ACTION_VIEW,Uri.parse(geo));

            }else if (pilihan.equals("Website")){
                String web = "http://sarangkepiting.business.site";
                k = new Intent(Intent.ACTION_VIEW,Uri.parse(web));

            }else if (pilihan.equals("Search Info")){
                k = new Intent(Intent.ACTION_WEB_SEARCH);
                k.putExtra(SearchManager.QUERY,("Sarang Kepiting Resto pekanbaru"));
