...
public class BKKepri extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan){
        ...
        try {
            ...
            if (pilihan.equals("Call Center")){
                String tel = "tel:0761848711";
                kp = new Intent(Intent.ACTION_DIAL, Uri.parse(tel));

            }else if (pilihan.equals("Info Maps")){
                String geo = "geo:0.516135,101.447808";
                kp = new Intent(Intent.ACTION_VIEW,Uri.parse(geo));
                // set app defualt untuk buka intent ini apabila ada beberapa aplikasi yang dapat membuka
                kp.setPackage("com.google.android.apps.maps");

            }else if (pilihan.equals("Driving Direction")){
                String geo ="google.navigation:q=0.516135,101.447808";
                kp = new Intent(Intent.ACTION_VIEW,Uri.parse(geo));

            }else if (pilihan.equals("Website")){
                String web = "http://bi.go.id";
                kp = new Intent(Intent.ACTION_VIEW,Uri.parse(web));

            }else if (pilihan.equals("Search Info")){
                kp = new Intent(Intent.ACTION_WEB_SEARCH);
                kp.putExtra(SearchManager.QUERY,("Bank Riau Kepri Cabang Pekanbaru"));
                ...
                kp = new Intent(Intent.ACTION_VIEW,dekatsaya);
                kp.setPackage("com.google.android.apps.maps");
