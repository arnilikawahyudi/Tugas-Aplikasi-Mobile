...
public class Sushi extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan){
        ...
        try {
            ...
            if (pilihan.equals("Call Center")){
                ...
                String geo ="google.navigation:q=0.531239,101.419406";
                su = new Intent(Intent.ACTION_VIEW,Uri.parse(geo));

            }else if (pilihan.equals("Website")){
                String web = "http://sushitei.co.id";
                su = new Intent(Intent.ACTION_VIEW,Uri.parse(web));

            }else if (pilihan.equals("Search Info")){
                su = new Intent(Intent.ACTION_WEB_SEARCH);
                su.putExtra(SearchManager.QUERY,("Sushi Tei Pekanbaru Resto"));
